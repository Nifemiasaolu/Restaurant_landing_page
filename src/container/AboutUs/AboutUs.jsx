...
const AboutUs = () => (
  <div className=" section-padding app-bg flex-center relative h-screen">
    <div>
      <img
        src={images.G}
        alt="G"
    ...
    <div className="flex-center absolute gap-4">
      <div className="flex flex-1 items-end justify-end text-right flex-col">
        ...
        <p className="text-xs text-lightGrey w-[10rem] sm:w-[20rem]">
      ...
      <div>
        <img
          src={images.knife}
          alt="knife"
          className="h-[25rem] mx-2 w-[3rem] sm:h-[25rem] sm:w-[3rem]"
        />
      </div>
